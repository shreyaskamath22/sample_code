...
class comm_basic_commission_formula(osv.osv):
    _name = "comm.basic.commission.formula"
    _table = "comm_basic_commission_formula"
    
    _columns = {
                'comm_name':fields.char('Formula Name', size=64, required=True),
                'comm_designation': fields.many2one('hr.job', 'Designation', required=True),
                'comm_start_date': fields.date('Start Date', required=True),
                'comm_end_date': fields.date('End Date', required=True),
                'comm_inactive': fields.boolean('Inactive'),
                'comm_emp_type':fields.many2one('hr.employee.type', 'Employee Type'),
                'comm_store_class':fields.many2one('stores.classification', 'Stores Classification'),
                'comm_prod_type':fields.many2one('product.category', 'Product Type'),
                'comm_cc_type':fields.many2one('credit.class.type', 'Credit Class Type'),
                'comm_business_rule':fields.many2one('business.rule.master', 'Business Rule Applicable'),
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'comm_percent': fields.float('Percentage of revenue'),
                'comm_flat_amount':fields.float('Flat Commission Amount'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','comm_base_id','Mapped Fields')
       }

comm_basic_commission_formula()

class comm_base_box_commission_formula(osv.osv):
    _name = "comm.base.box.commission.formula"
    _columns = {
                'comm_name':fields.char('Formula Name', size=64, required=True),
                'comm_designation': fields.many2one('hr.job', 'Designation', required=True),
                'comm_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'comm_percent':fields.float('Percentage to recieve Box Goal'),
                'comm_box': fields.float('Flat Commission Amount (per Box Sold)'),
                'spiff_business_class':fields.one2many('attached.multiple.business.rule.master','base_box_id','Comm Business Relation'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','comm_base_box_id','Mapped Fields')
       }

comm_base_box_commission_formula()

class comm_kicker_commission_formula(osv.osv):
    _name = "comm.kicker.commission.formula"
    _columns = {
                'comm_name':fields.char('Formula Name', size=64, required=True),
                'comm_designation': fields.many2one('hr.job', 'Designation', required=True),
                'comm_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'comm_rev_goal_percent': fields.float('SA Revenue Goal Attainment Percentage'),
                'comm_rev_goal_amount': fields.float('SA Revenue Goal Attainment Amount'),
                'comm_box_goal_percent': fields.float('SA BOX Goal Attainment Percentage'),
                'comm_box_goal_amount': fields.float('SA BOX Goal Attainment Amount'),
                'comm_store_rev_goal_percent': fields.float('Store Revenue Goal Attainmenrt Percentage'),
                'comm_store_rev_goal_amount': fields.float('Store Revenue Goal Attainmenrt Amount'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','comm_kicker_id','Mapped Fields')
       }

comm_kicker_commission_formula()

class comm_turnover_formula(osv.osv):
    _name = 'comm.turnover.formula'
    _columns = {
                'comm_name':fields.char('Formula Name', size=64, required=True),
                'comm_designation': fields.many2one('hr.job', 'Designation', required=True),
                'comm_start_date': fields.date('Start Date', required=True),
                ...
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','comm_turnover_id','Mapped Fields'),
                'comm_fixed_amount_on_goal':fields.one2many('comm.revenue.goal.attainment.diff.percent', 'comm_turnover_id', 'Turnover Payout Criteria'),
    }
comm_turnover_formula()

class comm_revenue_goal_attainment_formula(osv.osv):
    _name = "comm.revenue.goal.attainment.formula"
    _columns = {
                'comm_name':fields.char('Formula Name', size=64, required=True),
                'comm_designation': fields.many2one('hr.job', 'Designation', required=True),
                'comm_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'comm_fixed_amount_above_100': fields.float('Amount Commission(* % to Goal (100%+))'),
                'comm_fixed_amount_100': fields.float('Amount Commission (100%)'),
                'comm_fixed_amount_on_goal':fields.one2many('comm.revenue.goal.attainment.diff.percent', 'comm_id', 'Amount Commission on Percent Goal Attainment'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','comm_rev_goal_att_id','Mapped Fields')
            }

comm_revenue_goal_attainment_formula()

class comm_revenue_goal_attainment_diff_percent(osv.osv):
    _name = 'comm.revenue.goal.attainment.diff.percent'
    _columns = {
                'comm_id':fields.many2one('comm.revenue.goal.attainment.formula', 'Commission Revenue Goal Attainment Id'),
                'att_business_rule':fields.many2one('business.rule.master', 'Busienss Rule'),
                'comm_min_percent':fields.float('Minimum Percentage of Goal'),
                'comm_max_percent':fields.float('Maximum Percentage of Goal'),
                'comm_fixed_amount':fields.float('Flat Amount'),
                'comm_amnt_goal_mul':fields.float('Amount(* %to Goal)'),
                'pay_on_rev':fields.float('Pay on Revenue'),
                'comm_turnover_id':fields.many2one('comm.turnover.formula','Turnover Formula Id')
    }
comm_revenue_goal_attainment_diff_percent()

class comm_top_box_psa_goal_attainment_formula(osv.osv):
    _name = "comm.top.box.psa.goal.attainment.formula"
    _columns = {
                'comm_name':fields.char('Formula Name', size=64, required=True),
                'comm_designation': fields.many2one('hr.job', 'Designation', required=True),
                'comm_start_date': fields.date('Start Date', required=True),
                ...
                'comm_fixed_amount_above_100': fields.float('Amount Commission(* % to Goal (100%+))'),
                'comm_fixed_amount_100': fields.float('Amount Commission (100%)'),
                'comm_fixed_amount_on_goal':fields.one2many('comm.top.box.psa.goal.attainment.diff.percent', 'comm_id', 'Amount Commission on Percent Goal Attainment'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','comm_box_psa_id','Mapped Fields')
            }

comm_top_box_psa_goal_attainment_formula()

class comm_top_box_psa_goal_attainment_diff_percent(osv.osv):
    _name = 'comm.top.box.psa.goal.attainment.diff.percent'
    _columns = {
                'comm_id':fields.many2one('comm.top.box.psa.goal.attainment.formula', 'Commission Revenue Goal Attainment Id'),
                'comm_min_percent':fields.float('Minimum Percentage of Goal'),
                'comm_max_percent':fields.float('Maximum Percentage of Goal'),
                'comm_fixed_amount':fields.float('Commission Amount'),
    }
comm_top_box_psa_goal_attainment_diff_percent()

class comm_profitability_payout(osv.osv):
    _name = 'comm.profitability.payout'
    _columns = {
                'comm_name':fields.char('Formula Name', size=64, required=True),
                'comm_designation': fields.many2one('hr.job', 'Designation', required=True),
                'comm_start_date': fields.date('Start Date', required=True),
                ...
                'comm_cc_type':fields.many2one('credit.class.type', 'Credit Class Type'),
                'comm_business_rule':fields.many2one('business.rule.master', 'Business Rule Applicable'),
                'comm_profit_multi_bracket':fields.one2many('attached.multiple.business.rule.master','profit_id','Profitability Bracket'),
                'is_voc':fields.boolean('Consider VOC?'),
                'voc_operand':fields.selection([('lt','<'),('gt','>'),('eq','='),('lte','<='),('gte','>=')],'Operand'),
                'voc_factor':fields.float('VOC Factor'),
                'percent_pay_effect':fields.float('Percent Effect on Payout'),
                'flat_pay_effect':fields.float('Flat Amount Effect on Payout'),
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'comm_profit_payout_percent':fields.float('Profitability Payout Percentage'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','comm_profit_id','Mapped Fields')
    }
comm_profitability_payout()

# class comm_profitability_multi_bracket(osv.osv):
#     _name = 'comm.profitability.multi.bracket'
#     _description = "Profitability Multi Bracket"
#     _columns = {
#       'from_percent':fields.float('From Profit Percent'),
#       'profit_id':fields.many2one('comm.profitability.payout','Profit Id'),
#       'upto_percent':fields.float('Upto Profit Percent'),
#       'percent_pay':fields.float('Payout Percent on Revenue'),
#       'flat_pay':fields.float('Flat Payout'),
#       }
# comm_profitability_multi_bracket()

class comm_market_share_profitability_payout(osv.osv):
    _name = 'comm.market.share.profitability.payout'
    _columns = {
                'comm_name':fields.char('Formula Name', size=64, required=True),
                'comm_designation': fields.many2one('hr.job', 'Designation', required=True),
                'comm_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'comm_start_percent_labour':fields.float('Start Percentage of Labor Budgets'),
                'comm_end_percent_labour':fields.float('End Percentage of Labor Budgets'),
                'comm_percent_conversion':fields.float('% Conversion'),
                'comm_voc':fields.float('Factor of VOC'),
                'comm_percent_market_profit':fields.float('Percentage Of Market Profitability'),
                'comm_miss_metrics_percent':fields.float('Miss Metrics Percentage'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','comm_mkt_profit_id','Mapped Fields')
    }
comm_market_share_profitability_payout()

class comm_vision_rewards_elite_bonus(osv.osv):
    _name = "comm.vision.rewards.elite.bonus"
    _columns = {
                'comm_name':fields.char('Formula Name', size=64, required=True),
                'comm_designation': fields.many2one('hr.job', 'Designation', required=True),
                'emp_model_id':fields.selection([('rsa', 'RSA'), ('stl', 'STL'), ('mid', 'MID'), ('rsm', 'RSM'), ('mm', 'MM'), ('dos', 'DOS'), ('ca', 'CA'), ('cs', 'CS')], 'Heirarchy Level'),
                'comm_start_date': fields.date('Start Date', required=True),
                'comm_end_date': fields.date('End Date', required=True),
                'comm_inactive': fields.boolean('Inactive'),
                'comm_emp_type':fields.many2one('hr.employee.type', 'Employee Type'),
                ...
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'formula_multi_lines':fields.one2many('comm.vision.reward.multi.formula.line','comm_vision_id','Formula Multi'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','comm_elite_id','Mapped Fields')
       }

comm_vision_rewards_elite_bonus()

class comm_ops_leader_ranking_master(osv.osv):
    _name = 'comm.ops.leader.ranking.master'
    _columns = {
                'comm_name':fields.char('Formula Name', size=64, required=True),
                'comm_designation': fields.many2one('hr.job', 'Designation', required=True),
                'emp_model_id':fields.selection([('rsa', 'RSA'), ('stl', 'STL'), ('mid', 'MID'), ('rsm', 'RSM'), ('mm', 'MM'), ('dos', 'DOS'), ('ca', 'CA'), ('cs', 'CS')], 'Heirarchy Level'),
                ...
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'formula_multi_lines':fields.one2many('comm.vision.reward.multi.formula.line','comm_ops_id','Formula Multi'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','comm_ops_id','Mapped Fields')
    }
comm_ops_leader_ranking_master()

class comm_vision_reward_multi_formula_line(osv.osv):
    _name = 'comm.vision.reward.multi.formula.line'
    _columns = {
                'comm_vision_id':fields.many2one('comm.vision.rewards.elite.bonus', 'Vision Reward ID'),
                'comm_ops_id':fields.many2one('comm.ops.leader.ranking.master', 'Ops Leaderboard ID'),
                'rank_base':fields.selection([('all','Overall'),('rev','Revenue')],'Ranks Based On'),
                'cal_level':fields.many2one('ir.model','Ranking At Level'),
                'cal_type':fields.selection([('perc','Percent'),('count','Count')],'Ranks Result Type'),
                'from_cond':fields.float('From Count'),
                'to_cond':fields.float('To Count'),
                'pay_rev':fields.float('Payout on Revenue'),
                'flat_pay':fields.float('Flat Payout')
    }
comm_vision_reward_multi_formula_line()

class hr_department(osv.osv):
    _inherit = 'hr.department'
    _columns = {
                'wp_active':fields.boolean('Wireless Love')
    }
hr_department()

class commission_tracker(osv.osv_memory):
    _name = 'commission.tracker'
    
    def _get_start_date(self, cr, uid, context=None):
        if str(date.today()) == str(time.strftime('%Y-%m-01')):
    ...
    # def wordpress_wv_love(self, cr, uid, context=None):
        # love_ids = []
        # date_data = datetime.now(pytz.timezone('US/Mountain')).date()
        # day = date_data.day
        # month = date_data.month
        # cr.execute('''select hr.name_related,hr.last_name,dept.name,hr.hire_date,hr.birthday from hr_employee hr, hr_department dept
# where hr.department_id = dept.id and (extract(month from hr.hire_date) = %s and extract(day from hr.hire_date) = %s
                     # or extract(month from hr.birthday) = %s and extract(day from hr.birthday) = %s)
# and dept.wp_active = true limit 5''',(month,day,month,day))
        # love_data = cr.fetchall()
        # if love_data:
            # for love_data_each in  love_data:
                # love_ids.append([love_data_each[0] or '',love_data_each[1] or '',love_data_each[2] or '',love_data_each[3] or '',love_data_each[4] or ''])
        # return love_ids

    # def wordpress_top_emp(self, cr, uid, context=None):
        # emp_ids = []
        # start_date = self._get_start_date(cr, uid, context=context)
        # end_date = self._get_end_date(cr, uid, context=context)
        # cr.execute('''select hr.name_related, hr.last_name, sap.wv_store, mkt.name from sp_getRanking_SalesRep(100,'2015-05-01','2015-05-31',null,null) fn,
# hr_employee hr, sap_store sap, market_place mkt
# where fn.category = hr.id and hr.store_id = sap.id and sap.market_id = mkt.id and fn.value > 0 limit 5''',(start_date,end_date))
        # emp_data = cr.fetchall()
        # if emp_data:
            # for emp_data_each in emp_data:
                # emp_ids.append([emp_data_each[0],emp_data_each[1],emp_data_each[2],emp_data_each[3]])
        # return emp_ids

    # def wordpress_top_store(self, cr, uid, context=None):
        # store_ids = []
        # start_date = self._get_start_date(cr, uid, context=context)
        # end_date = self._get_end_date(cr, uid, context=context)
        # cr.execute('''select category from sp_getRanking_RMS(100,%s,%s,'store','perc')
# where value > 0 limit 5''', (start_date, end_date))
        # store_data = cr.fetchall()
        # if store_data:
            # for store_data_each in store_data:
                # store_ids.append(store_data_each[0])
        # return store_ids

    # def wordpress_top_market(self, cr, uid, context=None):
        # market_ids = []
        # start_date = self._get_start_date(cr, uid, context=context)
        # end_date = self._get_end_date(cr, uid, context=context)
        # cr.execute('''select category from sp_getRanking_RMS(100,%s,%s,'market','perc')
# where value > 0 limit 5''', (start_date, end_date))
        # market_data = cr.fetchall()
        # if market_data:
            # for market_data_each in market_data:
                # market_ids.append(market_data_each[0])
        # return market_ids

    # def wordpress_comp_data(self, cr, uid, context=None):
        # comp_data = []
        # start_date = self._get_start_date(cr, uid, context=context)
        # end_date = self._get_end_date(cr, uid, context=context)
        # cr.execute('''select * from sp_get_company_performance(%s,%s)''',(start_date, end_date))
        # company_data = cr.fetchall()
        # logger.error("Company Data :%s"%(company_data))
        # if company_data:
            # for company_data_each in company_data:
                # rev_goal = round(company_data_each[0], 2)
                # tbc = round(company_data_each[1], 2)
                # pda = round(company_data_each[2], 2)
                # acc_rev_box = round(company_data_each[3], 2)
                # rev_goal = str('%s'%(rev_goal,))
                # tbc = str('%s'%(tbc,))
                # pda = str('%s'%(pda,))
                # acc_rev_box = str('%s'%(acc_rev_box,))
                # comp_data.append(rev_goal)
                # comp_data.append(tbc)
                # comp_data.append(pda)
                # comp_data.append(acc_rev_box)
                # logger.error("Comp Data :%s"%(comp_data))
        # return comp_data
    ...
    _columns = {
        ...
        #**********
            ...
            #********* ends here ***************
                ...
                'jod_php_conv_percent':fields.float('JOD PHP Conversion Percent'),
...
#        result['res'] = res
    ...
    ###### Formula config Masters End here ###########
        ...
        res = super(commission_tracker, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type, context=context, toolbar=toolbar, submenu=False)
...
############### For Spiff tab dynamic design starts here ###################
    ...
    def create(self, cr, uid, vals, context=None):
        packaged_comm = self.pool.get('packaged.commission.tracker')
        ...
        packaged_search = packaged_comm.search(cr, uid, [('name', '=', name), ('start_date', '=', start_date), ('end_date', '>=', end_date)])
        # if packaged_search:
        #     raise osv.except_osv(('Warning'),("Selected time period is locked for Commission Tracker. Go to Sales Commission > Packaged Commission to see your payout for this period."))
        ...
        if start_date and end_date:
            ...
            if end_date < start_date:
                raise osv.except_osv(('Warning'), ("End date can not be back date from start date."))
        ...
        ##### code as per request by commissions team to allow to end only current month date.
#            if end_date_day >= time.strftime("%d"):
#                raise osv.except_osv(('Warning'), ("End date should be in same month and also should be less than Today's Date."))

        res_id = super(commission_tracker, self).create(cr, uid, vals, context=context)
        return res_id
    ...
    def write(self, cr, uid, ids, vals, context=None):
        ...
        name = self.browse(cr, uid, ids[0]).name.id
...
#       if end_date_day >= time.strftime("%d"):
#       raise osv.except_osv(('Warning'), ("End date should be in same month and also should be less than Today's Date."))
        res_id = super(commission_tracker, self).write(cr, uid, ids, vals, context=context)
        return res_id

    def default_get(self, cr, uid, fields, context=None):
        res = super(commission_tracker, self).default_get(cr, uid, fields, context=context)
        hr_obj = self.pool.get('hr.employee')
        emp_id = hr_obj.search(cr, uid, [('user_id', '=', context.get('uid') or uid)])
        if emp_id:
            ############### Updating res ####################
...
and pos.prm_dsr_smd = false and df.prm_dsr_smd = false
        ...
        for spiff_business_class_data in spiff_business_class:
            ...
            if plus_3gb_business_rule_id:
                ...
                if plus_3gb_business_rule_pos or plus_3gb_business_rule_upg:
                    from_num_cond += str('select id,dsr_monthly_access,dsr_product_code_type,dsr_imei_no,dsr_phone_purchase_type,crash_prm_job_id_rollback,prm_dsr_smd,prm_dsr_pmd,employee_id,store_id,market_id,region_id,dsr_act_date,state,postpaid_id,upgrade_id,true as created_feature,pseudo_date,dsr_emp_type,dsr_credit_class,dsr_product_code from wireless_dsr_feature_line union all ')
                if plus_3gb_business_rule_pre:
                    from_num_cond += str('select id,dsr_monthly_access,dsr_product_code_type,dsr_imei_no,dsr_phone_purchase_type,crash_prm_job_id_rollback,prm_dsr_smd,prm_dsr_pmd,employee_id,store_id,market_id,region_id,dsr_act_date,state,null as postpaid_id,null as upgrade_id,created_feature,pseudo_date,null as dsr_emp_type,null as dsr_credit_class,dsr_product_description from wireless_dsr_prepaid_line union all ')
    ...
    dsr_exclude_condition+''' ''',(emp_id,start_date,end_date,start_date,end_date))           
                ...
                cr.execute('''select count(df.id)
                    ...
                    '''+condition_string+
    dsr_exclude_condition+''' ''',(emp_id,start_date,end_date))
                count_3gb_store_data = cr.fetchall()
                count_3gb_percent_logic = count_3gb_store_data[0][0]
                cr.execute('''select count(df.id)
                    from ('''+from_num_cond+''')
    ...
    dsr_exclude_condition+''' ''',(emp_id,tuple(prm_job_id),tuple(actual_count_product_type)))
                ...
                if field_name == 'region_id':
                    cr.execute('''select count(sap.id) from sap_tracker sap, market_tracker mkt
                        where sap.market_id = mkt.market_id and 
    ...
    dsr_exclude_condition+''' ''',(emp_id,start_date,end_date,start_date,end_date))
        ...
        if vals['spiff_score_count'] != "":
            vals['spiff_score_count'] = vals['spiff_score_count'][:-2]
        return vals
    # **************** Commented for not considering actual count logic of 2014 as discussed *******************    
        # ###### numerator to be considered in actual count & payout logic ####################
        # ################## to make qery faster #####################################
        # if len(actual_count_product_type) < 4:
        #     cr.execute('''select count(df.id)
        #     from wireless_dsr_feature_line df
        #     where df.'''+field_name+''' = %s 
        #     and df.dsr_act_date between %s and %s
        #     and df.state = 'done'
        #     and df.dsr_product_code_type in %s''',(emp_id,start_date,end_date,tuple(actual_count_product_type)))
        #     actual_count_3gb_query = cr.fetchall()
        #     actual_count_3gb_data = actual_count_3gb_query[0][0]
        #     if not actual_count_3gb_data:
        #         actual_count_3gb_data = 0.00
        #     cr.execute('''select count(df.id)
        #     from wireless_dsr_feature_line df
        #     where df.'''+field_name+''' = %s 
        #     and df.crash_prm_job_id_rollback in %s
        #     and (df.prm_dsr_smd = true or df.prm_dsr_pmd = true)
        #     and df.state = 'done'
        #     and df.dsr_product_code_type in %s''',(emp_id,tuple(prm_job_id),tuple(actual_count_product_type)))
        #     actual_count_3gb_deact_query = cr.fetchall()
        #     actual_count_3gb_deact_data = actual_count_3gb_deact_query[0][0]
        #     if not actual_count_3gb_deact_data:
        #         actual_count_3gb_deact_data = 0.00
        # else:
        #     cr.execute('''select count(df.id)
        #     from wireless_dsr_feature_line df
        #     where df.'''+field_name+''' = %s 
        #     and df.dsr_act_date between %s and %s
        #     and df.state = 'done'
        #     and df.dsr_product_code_type in (select product_code_type from sub_business_rule_master where rule_id = %s)''',(emp_id,start_date,end_date,plus_3gb_business_rule_id.id))
        #     actual_count_3gb_query = cr.fetchall()
        #     actual_count_3gb_data = actual_count_3gb_query[0][0]
        #     if not actual_count_3gb_data:
        #         actual_count_3gb_data = 0.00
        ...
        #     and (df.prm_dsr_smd = true or df.prm_dsr_pmd = true)
        #     and df.state = 'done'
        #     and df.dsr_product_code_type in (select product_code_type from sub_business_rule_master where rule_id = %s)''',(emp_id,tuple(prm_job_id),plus_3gb_business_rule_id.id))
        #     actual_count_3gb_deact_query = cr.fetchall()
        #     actual_count_3gb_deact_data = actual_count_3gb_deact_query[0][0]
        #     if not actual_count_3gb_deact_data:
        #         actual_count_3gb_deact_data = 0.00
        # vals['count_3gb_smart_att'] = actual_count_3gb_data - actual_count_3gb_deact_data       
        # if vals['spiff_3gb_smart_percent'] >= vals['spiff_master_3gb_smart_percent']:
        #     spiff_3gb_smart_amount = spiff_feature_master_data.spiff_amount
        #     spiff_3gb_per_smart_amount = spiff_feature_master_data.spiff_per_att
        #     if spiff_3gb_per_smart_amount > 0.00:
        #         vals['spiff_3gb_smart_payout'] = vals['count_3gb_smart_att'] * spiff_3gb_per_smart_amount
        #     if spiff_3gb_smart_amount > 0.00:
        #         vals['spiff_3gb_smart_payout'] = spiff_3gb_smart_amount
...
and pos.prm_dsr_smd = false and df.prm_dsr_smd = false
    ...
    def _calculate_jod_php_attachment(self, cr, uid, field_name, start_date, end_date, emp_id, spiff_feature_master_ids, prm_job_id, tot_rev, emp_model_id,master_br_dict,master_br_emp_type,master_br_cc,master_br_prod_code,master_br_soc):
        ...
        for spiff_business_class_data in spiff_business_class:
            ...
            if plus_3gb_business_rule_pos:
                from_condition += str('select id,product_id,dsr_monthly_access,dsr_product_code_type,dsr_imei_no,dsr_phone_purchase_type,crash_prm_job_id_rollback,prm_dsr_smd,prm_dsr_pmd,employee_id,store_id,market_id,region_id,dsr_act_date,state,pseudo_date,dsr_emp_type,dsr_credit_class,dsr_product_code,dsr_jod,is_jump,null::integer as postpaid_id,null::integer as upgrade_id from wireless_dsr_postpaid_line union all ')
            if plus_3gb_business_rule_upg:
                from_condition += str('select id,product_id,dsr_monthly_access,dsr_product_code_type,dsr_imei_no,dsr_phone_purchase_type,crash_prm_job_id_rollback,prm_dsr_smd,prm_dsr_pmd,employee_id,store_id,market_id,region_id,dsr_act_date,state,pseudo_date,dsr_emp_type,dsr_credit_class,dsr_product_code,dsr_jod,is_jump,null::integer as postpaid_id,null::integer as upgrade_id from wireless_dsr_upgrade_line union all ')
            if plus_3gb_business_rule_fea:
                from_condition += str('select id,feature_product_id,dsr_monthly_access,dsr_product_code_type,dsr_imei_no,dsr_phone_purchase_type,crash_prm_job_id_rollback,prm_dsr_smd,prm_dsr_pmd,employee_id,store_id,market_id,region_id,dsr_act_date,state,pseudo_date,dsr_emp_type,dsr_credit_class,dsr_product_code,dsr_jod,false as is_jump,postpaid_id,upgrade_id from wireless_dsr_feature_line union all ')
...
union all
select id,feature_product_id,dsr_monthly_access,dsr_rev_gen,dsr_trans_type,true,dsr_product_code_type,prm_dsr_smd,dsr_imei_no,dsr_phone_purchase_type,crash_prm_job_id_rollback,prm_dsr_pmd,employee_id,store_id,market_id,region_id,dsr_act_date,state,prm_react_recon,pseudo_date,dsr_emp_type,dsr_credit_class,dsr_product_code from wireless_dsr_feature_line) 
...
and upg.state = 'done'
and upg.crash_prm_job_id_rollback in %s
and upg.prm_dsr_pmd = true''',(store_multi_id,tuple(prm_job_id)))
            emp_data = cr.fetchall()
            deact_rev = emp_data[0][0]
            deact_box = emp_data[0][1]
            if not deact_rev:
...
and test.prm_dsr_smd = false'''
+rev_dsr_exclude_condition+'''
group by dsr_trans_type
order by dsr_trans_type asc''',(store_multi_id, start_date, end_date,start_date,end_date))
        store_data = cr.fetchall()
        for store_data_id in store_data:
...
##### function to calculate the Company Level prepaid conversion
##### for Kiosk Store type 
...
############ DOS region consideration from Region Tracker Table #################
        ...
        # ############### Goal Calculation #################################
        from_box_condition = str('')
        business_box_rule_ids = business_rule_master.search(cr, uid, [('is_box','=',True), ('active', '=', True), ('comm_report_selection', '=', 'commission')])
        if business_box_rule_ids:
            ...
            if box_is_postpaid:
                from_box_condition += str('''select id,product_id,dsr_monthly_access,dsr_rev_gen,dsr_trans_type,true as created_feature,dsr_product_code_type,prm_dsr_smd,dsr_imei_no,dsr_phone_purchase_type,crash_prm_job_id_rollback,prm_dsr_pmd,employee_id,store_id,market_id,region_id,dsr_act_date,state,prm_react_recon,pseudo_date,dsr_emp_type,dsr_credit_class,dsr_product_code
from wireless_dsr_postpaid_line union all ''')
            if box_is_prepaid:
                from_box_condition += str('''select id,product_id,dsr_monthly_access,dsr_rev_gen,dsr_trans_type,created_feature,dsr_product_code_type,prm_dsr_smd,dsr_imei_no,dsr_phone_purchase_type,crash_prm_job_id_rollback,prm_dsr_pmd,employee_id,store_id,market_id,region_id,dsr_act_date,state,prm_react_recon,pseudo_date,null as dsr_emp_type,null as dsr_credit_class,dsr_product_description
from wireless_dsr_prepaid_line union all ''')
            if box_is_upgrade:
                from_box_condition += str('''select id,product_id,dsr_monthly_access,dsr_rev_gen,dsr_trans_type,true,dsr_product_code_type,prm_dsr_smd,dsr_imei_no,dsr_phone_purchase_type,crash_prm_job_id_rollback,prm_dsr_pmd,employee_id,store_id,market_id,region_id,dsr_act_date,state,prm_react_recon,pseudo_date,dsr_emp_type,dsr_credit_class,dsr_product_code
from wireless_dsr_upgrade_line union all ''')
...
and hr.job_id=job.id and job.model_id in ('rsa','stl')''')
            ...
            for comm_emp_search_id in comm_emp_search_ids:
                ...
                for comm_formula_multi_lines_each in comm_formula_multi_lines:
                    ...
                    if comm_formula_multi_lines_each.rank_base == 'all':
                        cr.execute('''select * from sp_getRanking_SalesRep(%s)''', (start_date,))
                        ...
                        cr.execute('''select * from get_revenue_perc_by_emp_odoo(%s)''', (start_date,))
                        company_top_hr_ids = cr.fetchall()
                        for company_top_hr_id in company_top_hr_ids:
                            company_top_hr.append(company_top_hr_id[0])
                            company_top_rank.append(company_top_hr_id[1])                        
        ...
        if comm_stl_search_ids:
            ...
            for comm_stl_search_id in comm_stl_search_ids:
                ...
                store_top_hr = []
                store_top_rank = []
                cr.execute('''select * from sp_getRanking_RMS(%s,'store')''', (start_date,))
  ...
  #******************# ################### For Market Manager ############################
        ...
        if comm_mm_search_ids:
            ...
            for comm_mm_browse_data in comm_obj.browse(cr, uid, comm_mm_search_ids):
                ...
                count = 0
                cr.execute('''select * from sp_getRanking_RMS(%s,'market')''', (start_date,))
        ...
        if comm_dos_search_ids:
            ...
            for comm_formula_multi_lines_each in comm_formula_multi_lines:
                ...
                if comm_formula_multi_lines_each.rank_base == 'all':
                    cr.execute('''select * from sp_getRanking_RMS(%s,'region')''', (start_date,))
...
and start_date <= %s and end_date >= %s''',(region_id,start_date,end_date))
        ...
        if spiff_feature_store_ids:
            ...
            if dealer_obj_search_single:
                emp_spiff_feature_data = self._calculate_feature_attachment(cr, uid, field_name, start_date, end_date, store_id, spiff_feature_store_ids,prm_job_id,tot_rev,emp_model_id)
                demo_field1_goals = emp_spiff_feature_data['spiff_master_3gb_smart_percent']
                demo_field1_percent = emp_spiff_feature_data['spiff_3gb_smart_percent']
                demo_field1_payout = emp_spiff_feature_data['spiff_3gb_smart_payout']
                demo_field1_count = emp_spiff_feature_data['count_3gb_smart_att']
    ...
    from wireless_dsr_upgrade_line) as test inner join wireless_dsr dsr on (test.product_id = dsr.id)
                                        ...
                                        and dsr.state = 'done' 
                                        and cr.category_type = %s
                                        and test.prm_dsr_smd = false''', (store_id, start_date, end_date, spiff_cc_type))
...
and left(upg.dsr_imei_no,8) in (select tac_code from tac_code_master where phone_type in %s)''', (store_id, start_date, end_date, tuple(spiff_phone_type)))
        ...
        gross_payout = gross_payout + voc_payout + labor_prod_payout + vision_reward_sale_top_comp_leader_payout + vision_reward_ops_top_store_pay + float(vision_reward_mm_top_ops_market_payout) + vision_reward_dos_top_ops_payout + spiff_score_payout
        gross_payout = gross_payout + small_b2b_payout + turnover_payout + jod_php_attach_payout
        ...
        self.write(cr, uid, ids, { 'base_tot_rev':base_tot_rev,
                                ...
                                # *****************
                                    ...
                                    'mi_conv_count':spiff_mi_conv_count,
        ...
        cr.execute("select id from ir_ui_view where model='commission.tracker' and type='form' and name='commission.tracker.form'")
...
class spiff_jump_attachment(osv.osv):
    _name = "spiff.jump.attachment"
    _columns = {
                'spiff_name':fields.char('Formula Name', size=64, required=True),
                'spiff_designation': fields.many2one('hr.job', 'Designation', required=True),
                'spiff_start_date': fields.date('Start Date', required=True),
                'spiff_end_date': fields.date('End Date', required=True),
                'spiff_inactive': fields.boolean('Inactive'),
                'spiff_emp_type':fields.many2one('hr.employee.type', 'Employee Type'),
                'spiff_store_class':fields.many2one('stores.classification', 'Stores Classification'),
                'spiff_prod_type':fields.many2one('product.category', 'Product Type'),
                'spiff_cc_type':fields.many2one('credit.class.type', 'Credit Class Type'),
                'spiff_business_rule':fields.many2one('business.rule.master', 'Business Rule Applicable'),
                'spiff_business_class':fields.one2many('attached.multiple.business.rule.master','jump_id','Spiff Business Relation'),
                'spiff_phone_type':fields.many2many('phone.type.master', 'spiff_jump_phone_rel', 'jump_id', 'phone_id', 'Applicable Phone Type'),
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'spiff_percent': fields.float('Percentage of Attachment'),
                'spiff_per_att':fields.float('Spiff Amount (Per Attachment)'),
                'spiff_amount':fields.float('Spiff Amount'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','spiff_jump_id','Mapped Fields')
       }

spiff_jump_attachment()

class spiff_prepaid_goal(osv.osv):
    _name = "spiff.prepaid.goal"
    _columns = {
                'spiff_name':fields.char('Formula Name', size=64, required=True),
                'spiff_designation': fields.many2one('hr.job', 'Designation', required=True),
                'spiff_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'spiff_percent': fields.float('Percentage to hit for Prepaid spiff'),
                'spiff_amount':fields.float('Flat Spiff Amount'),
                'spiff_per_att':fields.float('Spiff Per Count'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','spiff_prepaid_id','Mapped Fields')
       }

spiff_prepaid_goal()

class spiff_feature_attachment(osv.osv):
    _name = "spiff.feature.attachment"
    _columns = {
                'spiff_name':fields.char('Formula Name', size=64, required=True),
                'spiff_designation': fields.many2one('hr.job', 'Designation', required=True),
                'spiff_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_store_class':fields.many2one('stores.classification', 'Stores Classification'),
                'spiff_prod_type':fields.many2one('product.category', 'Product Type'),
                'spiff_prod_code_type':fields.many2one('product.category', 'Product Code Type'),
                'spiff_cc_type':fields.many2one('credit.class.type', 'Credit Class Type'),
                'spiff_field_name':fields.many2one('ir.model.fields', 'Applicable Rule to'),
                'spiff_phone_type':fields.many2many('phone.type.master', 'spiff_feature_phone_rel', 'jump_id', 'phone_id', 'Applicable Phone Type'),
                'spiff_business_rule':fields.many2one('business.rule.master', 'Business Rule Applicable'),
                'spiff_business_class':fields.one2many('attached.multiple.business.rule.master','feature_id','Spiff Business Relation'),
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'spiff_label':fields.char('Label Name'),
                'comm_notes':fields.text('Notes'),
                'spiff_percent': fields.float('Percentage of Attachment'),
                'spiff_per_att':fields.float('Spiff Amount (Per Attachment)'),
                'spiff_amount':fields.float('Spiff Amount'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','spiff_feature_id','Mapped Fields')
       }

spiff_feature_attachment()

class spiff_prepaid_conversion(osv.osv):
    _name = 'spiff.prepaid.conversion'
    _columns = {
                'spiff_name':fields.char('Formula Name', size=64, required=True),
                'spiff_designation': fields.many2one('hr.job', 'Designation', required=True),
                'spiff_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'prepaid_business_class':fields.one2many('attached.multiple.business.rule.master','pre_conv_id','Spiff Business Relation'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','spiff_pre_conv_id','Mapped Fields')
    }
spiff_prepaid_conversion()

class attached_multiple_business_rule_master(osv.osv):
    _name = "attached.multiple.business.rule.master"
    _columns = {
                'att_business_rule':fields.many2one('business.rule.master','Condition Business Rule'),
                'att_condition_percent':fields.float('From Condition Percent/Count'),
                'to_condition_percent':fields.float('Upto Condition Percent/Count'),
                'apk_goal':fields.float('APK Revenue Goal'),
                'apk_count_goal':fields.float('Avg. APK sold'),
                'payout_business_rule':fields.many2one('business.rule.master', 'Payout Business Rule'),
                'pay_per_att':fields.float('Payout per Count'),
                'pay_on_rev':fields.float('Payout on Revenue'),
                'pay_flat_amnt':fields.float('Flat Amount'),
                'feature_id':fields.many2one('spiff.feature.attachment','Feature Id'),
                'jump_id':fields.many2one('spiff.jump.attachment','JUMP Id'),
                'mi_id':fields.many2one('spiff.mobile.internet','Mobile Internet Master Id'),
                'tbc_id':fields.many2one('spiff.store.total.box.conversion','Total Box Conversion Id'),
                'profit_id':fields.many2one('comm.profitability.payout', 'Profit Master Id'),
                'score_id':fields.many2one('spiff.score','Score Attachment Id'),
                'apk_id':fields.many2one('spiff.apk','APK Master Id'),
                'pre_conv_id':fields.many2one('spiff.prepaid.conversion','Prepaid Conversion Id'),
                'b2b_id':fields.many2one('spiff.small.business','Small Business'),
                'hit_goal_target':fields.boolean('Hit Goal Target'),
                'jod_php_id':fields.many2one('spiff.jod.php.att','JOD PHP Attachment'),
                'base_box_id':fields.many2one('comm.base.box.commission.formula', 'Box Goal Formula')
        }
attached_multiple_business_rule_master()

class spiff_mobile_internet(osv.osv):
    _name = "spiff.mobile.internet"
    _columns = {
                'spiff_name':fields.char('Formula Name', size=64, required=True),
                'spiff_designation': fields.many2one('hr.job', 'Designation', required=True),
                'spiff_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_prod_code_type':fields.many2one('product.category', 'Product Code Type'),
                'spiff_cc_type':fields.many2one('credit.class.type', 'Credit Class Type'),
                'spiff_business_class':fields.one2many('attached.multiple.business.rule.master','mi_id','Spiff Business Relation'),
                'spiff_phone_type':fields.many2many('phone.type.master', 'spiff_mi_phone_rel', 'jump_id', 'phone_id', 'Applicable Phone Type'),
                'spiff_business_rule':fields.many2one('business.rule.master', 'Business Rule Applicable'),
                'spiff_field_name':fields.many2one('ir.model.fields', 'Applicable Rule to'),
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'spiff_label':fields.char('Label Name'),
                'comm_notes':fields.text('Notes'),
                'spiff_amount':fields.float('Spiff Amount'),
                'spiff_per_amount':fields.float('Spiff Per Attachment Amount'),
                'spiff_conv_percent':fields.float('Conversion Percentage'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','spiff_mi_id','Mapped Fields')
       }

spiff_mobile_internet()

class spiff_apk(osv.osv):
    _name = "spiff.apk"
    _description = "APK"
    _columns = {
                'spiff_name':fields.char('Formula Name', size=64, required=True),
                ...
                'spiff_cc_type':fields.many2one('credit.class.type', 'Credit Class Type'),
                'spiff_business_rule':fields.many2one('business.rule.master', 'Business Rule Applicable'),
                'spiff_business_class':fields.one2many('attached.multiple.business.rule.master','apk_id','Spiff Business Relation'),
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'spiff_hit_percent':fields.float('Percentage to hit'),
                'spiff_per_box_acc_sold':fields.float('Average Per Box accessory sold'),
                'spiff_amount':fields.float('Flat Spiff to be Given'),
                'spiff_on_rev':fields.float('Payout Percent on Revenue'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','spiff_apk_id','Mapped Fields')
       }

spiff_apk()

class spiff_jod_php_att(osv.osv):
    _name = 'spiff.jod.php.att'
    _columns = {
                'spiff_name':fields.char('Formula Name', size=64, required=True),
                'spiff_designation': fields.many2one('hr.job', 'Designation', required=True),
                'spiff_start_date': fields.date('Start Date', required=True),
                'spiff_end_date': fields.date('End Date', required=True),
                'spiff_inactive': fields.boolean('Inactive'),
                'spiff_business_class':fields.one2many('attached.multiple.business.rule.master','jod_php_id','Spiff Business Relation'),
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','spiff_jod_php_id','Mapped Fields')
    }

class spiff_store_total_box_conversion(osv.osv):
    _name = "spiff.store.total.box.conversion"
    _columns = {
                'spiff_name':fields.char('Formula Name', size=64, required=True),
                'spiff_designation': fields.many2one('hr.job', 'Designation', required=True),
                'spiff_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_cc_type':fields.many2one('credit.class.type', 'Credit Class Type'),
                'spiff_business_rule':fields.many2one('business.rule.master', 'Business Rule Applicable'),
                'spiff_business_class':fields.one2many('attached.multiple.business.rule.master','tbc_id','Spiff Business Relation'),
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'spiff_conv_percent':fields.float('Box Conversion Percent'),
                'spiff_rev_pay':fields.float('Percent of revenue'),
                'spiff_store_tot_box_conv':fields.one2many('spiff.store.total.box.conversion.master', 'conv_id', 'Store Total Box Conversion'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','spiff_tbc_id','Mapped Fields')
       }

spiff_store_total_box_conversion()

class spiff_store_total_box_conversion_master(osv.osv):
    _name = 'spiff.store.total.box.conversion.master'
    _columns = {
                'conv_id':fields.many2one('spiff.store.total.box.conversion', 'Store total box conversion ID'),
                'spiff_percent_conv':fields.float('Percent Conversion'),
                'spiff_amount':fields.float('Spiff Amount'),
    }
spiff_store_total_box_conversion_master()

class spiff_application_goal(osv.osv):
    _name = 'spiff.application.goal'
    _columns = {
                'spiff_name':fields.char('Formula Name', size=64, required=True),
                'spiff_designation': fields.many2one('hr.job', 'Designation', required=True),
                'spiff_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_business_rule':fields.many2one('business.rule.master', 'Business Rule Applicable'),
                'comm_notes':fields.text('Notes'),
                'spiff_amount_above_200':fields.float('Spiff Amount (200%+)'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'spiff_app_goal_master':fields.one2many('spiff.application.goal.master', 'spiff_app_id', 'Application Goal'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','spiff_app_goal_id','Mapped Fields')
    }
spiff_application_goal()

class spiff_application_goal_master(osv.osv):
    _name = 'spiff.application.goal.master'
    _columns = {
                'spiff_app_id':fields.many2one('spiff.application.goal', 'Application Goal ID'),
                'spiff_from_percent':fields.float('From Percent'),
                'spiff_to_percent':fields.float('To Percent'),
                'spiff_amount':fields.float('Spiff Amount'),
    }
spiff_application_goal_master()

class spiff_box_goal(osv.osv):
    _name = 'spiff.box.goal'
    _description = "Spiff Box Goal"
    _columns = {
                'spiff_name':fields.char('Formula Name', size=64, required=True),
                'spiff_designation': fields.many2one('hr.job', 'Designation', required=True),
                'spiff_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'spiff_percent_to_box':fields.float('Percent to Box Goal'),
                'spiff_amount':fields.float('Spiff Amount'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','spiff_box_goal_id','Mapped Fields')
    }
spiff_box_goal()

class spiff_boxes_with_tablet(osv.osv):
    _name = 'spiff.boxes.with.tablet'
    _description = "Boxes sold with Tablet"
    _columns = {
                'spiff_name':fields.char('Formula Name', size=64, required=True),
                'spiff_designation': fields.many2one('hr.job', 'Designation', required=True),
                'spiff_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_cc_type':fields.many2one('credit.class.type', 'Credit Class Type'),
                'spiff_business_rule':fields.many2one('business.rule.master', 'Business Rule Applicable'),
                'spiff_phone_type':fields.many2many('phone.type.master', 'spiff_box_phone_rel', 'jump_id', 'phone_id', 'Applicable Phone Type'),
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'spiff_percent_to_box':fields.float('Percent of Boxes sold'),
                'spiff_amount':fields.float('Spiff Amount'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','spiff_box_with_tab_id','Mapped Fields')
    }
spiff_boxes_with_tablet()

class spiff_profitability(osv.osv):
    _name = 'spiff.profitability'
    _columns = {
                'spiff_name':fields.char('Formula Name', size=64, required=True),
                'spiff_designation': fields.many2one('hr.job', 'Designation', required=True),
                'spiff_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'spiff_profit_percent':fields.float('Profitability Percent'),
                'spiff_payout':fields.float('Spiff Amount'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','spiff_profit_id','Mapped Fields')
    }
spiff_profitability()

class comm_rph_commission(osv.osv):
    _name = 'comm.rph.commission'
    _description = "Revenue Per Hour Commission"
    _columns = {
                'comm_name':fields.char('Formula Name', size=64, required=True),
                'comm_designation': fields.many2one('hr.job', 'Designation', required=True),
                'comm_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'comm_rph_multi_bracket':fields.one2many('comm.rph.multi.bracket','rph_id','RPH'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','comm_rph_id','Mapped Fields')
        }

comm_rph_commission()

class comm_rph_multi_bracket(osv.osv):
    _name = 'comm.rph.multi.bracket'
    _description = "Revenue Per Hour Multi Condition"
    _columns = {
                'att_business_rule':fields.many2one('business.rule.master','Business Rule'),
                'from_rph_value':fields.float('From RPH (in $)'),
                'upto_rph_value':fields.float('Upto RPH (in $)'),
                'from_labor_budget':fields.float('From Labor Budget'),
                'to_labor_budget':fields.float('Upto Labor Budget'),
                'pay_percent_rev':fields.float('Percent payout of Revenue'),
                'pay_flat_amnt':fields.float('Flat Amount'),
                'rph_id':fields.many2one('comm.rph.commission', 'RPH Id'),
                'hit_rph_target':fields.boolean('Hit RPH Goal'),
                'rph_target_percent':fields.float('Goal Percent')
        }
comm_rph_multi_bracket()

class comm_voc_commission(osv.osv):
    _name = 'comm.voc.commission'
    _description = "VOC Commission"
    _columns = {
                'comm_name':fields.char('Formula Name', size=64, required=True),
                'comm_designation': fields.many2one('hr.job', 'Designation', required=True),
                'comm_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'voc_multi_bracket':fields.one2many('comm.voc.multi.bracket','voc_id','VOC Id'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','comm_voc_id','Mapped Fields')
        }
comm_voc_commission()

class comm_voc_multi_bracket(osv.osv):
    _name = 'comm.voc.multi.bracket'
    _description = "VOC Conditions"
    _columns = {
                'from_voc_value':fields.float('From VOC Factor'),
                'to_voc_value':fields.float('Upto VOC Factor'),
                'pay_percent':fields.float('Percent of Revenue'),
                'pay_flat':fields.float('Flat Amount'),
                'voc_id':fields.many2one('comm.voc.commission','VOC Id')
        }
comm_voc_multi_bracket()

class spiff_sqr_metric(osv.osv):
    _name = 'spiff.sqr.metric'
    _description = "SQR or Labor Metric"
    _columns = {
                'spiff_name':fields.char('Formula Name', size=64, required=True),
                'spiff_designation': fields.many2one('hr.job', 'Designation', required=True),
                'spiff_start_date': fields.date('Start Date', required=True),
                ...
                'spiff_model':fields.many2one('ir.model', 'Calculation Level (Eg.Employee, Store)'),
                'comm_notes':fields.text('Notes'),
                'spiff_payout':fields.float('SQR Payout'),
                'header_name':fields.many2one('commission.header','Header Name')
        }
spiff_sqr_metric()

class spiff_score(osv.osv):
    _name = 'spiff.score'
    _description = "Score"
    _columns = {
                'spiff_name':fields.char('Formula Name', size=64, required=True),
                ...
                'comm_notes':fields.text('Notes'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'spiff_business_class':fields.one2many('attached.multiple.business.rule.master','score_id','Spiff Business Relation'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','spiff_score_id','Mapped Fields')
        }
spiff_score()

class spiff_small_business(osv.osv):
    _name = 'spiff.small.business'
    _description = "Small Business"
    _columns = {
                'spiff_name':fields.char('Formula Name', size=64, required=True),
                'spiff_designation': fields.many2one('hr.job', 'Designation', required=True),
                'spiff_start_date': fields.date('Start Date', required=True),
                ...
                'comm_notes':fields.text('Notes'),
                'formula_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Formula Type'),
                'spiff_business_class':fields.one2many('attached.multiple.business.rule.master','b2b_id','Spiff Business Relation'),
                'header_name':fields.many2one('commission.header','Header Name'),
                'fields_mapped':fields.one2many('comm.design.field','spiff_small_b2b_id','Mapped Fields')
    }
spiff_small_business()

class reporting_header(osv.osv):
    _name = 'reporting.header'
    _description = "Reporting Header"
    _columns = {
                'name':fields.char('Header Name'),
                'rule_id':fields.many2one('business.rule.master', 'Business Rule Applicable'),
    }
reporting_header()

class commission_header(osv.osv):
    _name = 'commission.header'
    _description = "Commission Header"
    _columns = {
                'name':fields.char('Header Name'),
                'sequence':fields.integer('Sequence'),
                'header_type':fields.selection([('comm','Commission'),('spiff','Spiff')],'Header Type'),
                # 'sequence':fields.integer('Sequence'),
                'color':fields.selection([('red','Red'),('blue','Blue'),('green','Green'),('yellow','Yellow'),('violet','Violet')],'Header Color')
    }
    _order = 'sequence'
commission_header()

class comm_design_field(osv.osv):
    _name = 'comm.design.field'
    _columns = {
                'sequence':fields.integer('Sequence'),
                'field_id':fields.many2one('ir.model.fields','Mapping Field', domain="[('model_id','=','commission.tracker')]"),
                'field_label':fields.char('Field Label'),
                'comm_base_id':fields.many2one('comm.basic.commission.formula','Base Id'),
                'comm_base_box_id':fields.many2one('comm.base.box.commission.formula','Base Box Id'),
                'comm_rph_id':fields.many2one('comm.rph.commission','RPH Id'),
                'comm_voc_id':fields.many2one('comm.voc.commission','VOC Id'),
                'comm_kicker_id':fields.many2one('comm.kicker.commission.formula','Kicker Id'),
                'comm_rev_goal_att_id':fields.many2one('comm.revenue.goal.attainment.formula','Rev Goal Att Id'),
                'comm_box_psa_id':fields.many2one('comm.top.box.psa.goal.attainment.formula','Total Box PSA Id'),
                'comm_profit_id':fields.many2one('comm.profitability.payout','Profit Id'),
                'comm_mkt_profit_id':fields.many2one('comm.market.share.profitability.payout','Market Profit Id'),
                'comm_elite_id':fields.many2one('comm.vision.rewards.elite.bonus','Elite Bonus Id'),
                'comm_ops_id':fields.many2one('comm.ops.leader.ranking.master','Ops Leaderboard Id'),
                'spiff_jump_id':fields.many2one('spiff.jump.attachment','JUMP Id'),
                'spiff_prepaid_id':fields.many2one('spiff.prepaid.goal','Prepaid Goal Id'),
                'spiff_feature_id':fields.many2one('spiff.feature.attachment','Feature Id'),
                'spiff_mi_id':fields.many2one('spiff.mobile.internet','MI Id'),
                'spiff_apk_id':fields.many2one('spiff.apk','APK Id'),
                'spiff_jod_php_id':fields.many2one('spiff.jod.php.att','APK Id'),
                'spiff_tbc_id':fields.many2one('spiff.store.total.box.conversion','TBC Id'),
                'spiff_pre_conv_id':fields.many2one('spiff.prepaid.conversion','Prepaid Conv Id'),
                'spiff_app_goal_id':fields.many2one('spiff.application.goal','App Goal Id'),
                'spiff_box_goal_id':fields.many2one('spiff.box.goal','Box Goal Id'),
                'spiff_box_with_tab_id':fields.many2one('spiff.boxes.with.tablet','Box with Tab Id'),
                'spiff_profit_id':fields.many2one('spiff.profitability','Profit Id'),
                'spiff_score_id':fields.many2one('spiff.score','Score Id'),
                'spiff_small_b2b_id':fields.many2one('spiff.small.business','Small Business Id'),
                'comm_turnover_id':fields.many2one('comm.turnover.formula', 'Turnover Id')
    }
...
class business_rule_master(osv.osv):
    _name = 'business.rule.master'
    _description = "Business Rule"
    _columns = {
                'name':fields.char('Rule Name', size=128),
                'comm_report_selection':fields.selection([('commission', 'Commission'), ('reporting', 'Reporting'), ('pl_report', 'P&L Report')], 'Business Rule Type'),
                'is_inclusion':fields.boolean('Is Rule for Included Code Types?'),
                'is_postpaid':fields.boolean('Postpaid'),
                'is_upgrade':fields.boolean('Upgrade'),
                'is_feature':fields.boolean('Data Feature'),
                'is_prepaid':fields.boolean('Prepaid'),
                'is_acc':fields.boolean('Accessory'),
                'categ_ids':fields.many2many('product.category', 'rule_prod_type_rel', 'rule_id', 'prod_type_id', 'Excluded Product Code Types'),
                'included_feature':fields.many2many('product.category', 'included_feature_business_rel', 'rule_id', 'prod_type_id', 'Included Data Features'),
                'tac_code_rel':fields.many2many('phone.type.master', 'phone_type_business_rel', 'rule_id', 'phone_type_id', 'Included TAC Code'),
                'account_config_ids':fields.many2many('account.config.master', 'account_business_rel', 'rule_id', 'acc_conf_id', 'Included Accounts'),
                'account_config_ids_2':fields.many2many('account.config.master', 'account_business_rel_2', 'rule_id_2', 'acc_conf_id_2', 'Included Accounts_2'),
                'sub_rules' : fields.one2many('sub.business.rule.master', 'rule_id', 'Sub Business Rules'),
                'sub_rules_2' : fields.one2many('sub.business.rule.master_2', 'rule_id_2', 'Sub Business Rules_2'),
                'reporting_code':fields.char('Reporting Code'),
                'active':fields.boolean('Active'),
                'is_box':fields.boolean('Box Rule'),
    ...
    def create(self, cr, uid, vals, context=None):
        res = super(business_rule_master, self).create(cr, uid, vals, context=context)
        cr.execute('select get_combinations_subbusinessrules from get_combinations_subbusinessrules(%s)'% res)
        query_data = cr.fetchall()
        if query_data:
            # vals['reporting_code'] = query_data[0][0]
            self.write(cr, uid, [res], {'reporting_code':query_data[0][0]})
        return res

    def write(self, cr, uid, ids, vals, context=None):
        res = super(business_rule_master, self).write(cr, uid, ids, vals, context=context)
        cr.execute('select get_combinations_subbusinessrules from get_combinations_subbusinessrules(%s)'% ids[0])
        query_data = cr.fetchall()
        if query_data:
            # vals['reporting_code'] = query_data[0][0]
            res_2 = super(business_rule_master, self).write(cr, uid, ids, {'reporting_code':query_data[0][0]})
        return res

    def copy(self, cr, uid, id, default=None, context=None, done_list=None, local=False):
        sub_rule = self.pool.get('sub.business.rule.master')
        sub_rule_2 = self.pool.get('sub.business.rule.master_2')
        x =  super(business_rule_master, self).copy(cr, uid, id, default, context=context)
        default.update({'rule_id' : x,'rule_id_2' : x})
        company = self.browse(cr, uid, id, context=context)
        for each_rule in company.sub_rules:
            sub_rule.copy(cr, uid, each_rule.id,default)
        for each_rule_2 in company.sub_rules_2:
            sub_rule_2.copy(cr, uid, each_rule_2.id,default)
        return x

business_rule_master()

# # additional class to create sub business rules since there are few complexities 
# # in the current and need to match up with t mobile changing business
class sub_business_rule_master(osv.osv):

    _name = 'sub.business.rule.master'
    _description = "Sub Business rules"

    _columns = {
                'rule_id' : fields.many2one('business.rule.master', 'Business rules master'),
                'product_code_type' : fields.many2one('product.category', 'Product Code Type', domain=[('parent_id', '!=', False)]),
                'device_type' : fields.many2one('device.type.master', 'Device Type Master'),
                'class_type' : fields.many2one('credit.class.type', 'Class Type'),
                ...
                'dsr_jod':fields.boolean('JOD'),
                'tac_code_rel_sub_inc':fields.many2many('phone.type.master', 'phone_type_business_rel_sub_inc', 'rule_id', 'phone_type_id', 'Included TAC Code'),
    }

    def create(self, cr, uid, vals, context=None):
        cat_obj = self.pool.get('product.category')
        if vals['class_type']:
            categ_data = cat_obj.browse(cr, uid, vals['product_code_type'])
            parent_categ = categ_data.parent_id
            if parent_categ:
                parent_parent_categ = parent_categ.parent_id
                if parent_parent_categ:
                    parent_3_categ = parent_parent_categ.parent_id
                    if parent_3_categ:
                        prod_type = parent_3_categ.prod_type
                prod_type = parent_parent_categ.prod_type
            prod_type = parent_categ.prod_type
            if prod_type == 'prepaid':
                raise osv.except_osv(('Warning!'),('Prepaid code type does not depend on credit class type. Please blank class type for prepaid type of product code types.'))
        res = super(sub_business_rule_master, self).create(cr, uid, vals, context=context)
        return res

    def write(self, cr, uid, ids, vals, context=None):
        self_data = self.browse(cr, uid, ids[0])
        cat_obj = self.pool.get('product.category')
        if 'class_type' in vals:
            class_type = vals['class_type']
        else:
            class_type = self_data.class_type
        if 'product_code_type' in vals:
            product_code_type = vals['product_code_type']
        else:
            product_code_type = self_data.product_code_type.id
        if class_type and product_code_type:
            categ_data = cat_obj.browse(cr, uid, product_code_type)
            parent_categ = categ_data.parent_id
            if parent_categ:
                parent_parent_categ = parent_categ.parent_id
                if parent_parent_categ:
            ...
            if prod_type == 'prepaid':
                raise osv.except_osv(('Warning!'),('Prepaid code type does not depend on credit class type. Please blank class type for prepaid type of product code types.'))
        res = super(sub_business_rule_master, self).write(cr, uid, ids, vals, context=context)
        return res

sub_business_rule_master()
# ## class ends here

class sub_business_rule_master_2(osv.osv):

    _name = 'sub.business.rule.master_2'
    _description = "Sub Business rules_2"

    _columns = {
        'rule_id_2' : fields.many2one('business.rule.master', 'Business rules master'),
        'product_code_type_2' : fields.many2one('product.category', 'Product Code Type', domain=[('parent_id', '!=', False)]),
        'device_type_2' : fields.many2one('device.type.master', 'Device Type Master'),
        'class_type_2' : fields.many2one('credit.class.type', 'Class Type'),
        'dsr_phone_purchase_type_2':fields.selection([('new_device', 'EIP'), ('sim_only', 'SIM Only'), ('device_outright', 'Device Outright')], 'Phone Purchased'),
        'dsr_trade_inn_2':fields.selection([('yes', 'Yes'), ('no', 'No')], 'Trade Inn'),
        'paid_2':fields.boolean('Paid'),
        'dsr_jod_2':fields.boolean('JOD'),
        'tac_code_rel_sub_inc_2':fields.many2many('phone.type.master', 'phone_type_business_rel_sub_inc_2', 'rule_id', 'phone_type_id', 'Included TAC Code'),
    }

    def create(self, cr, uid, vals, context=None):
        cat_obj = self.pool.get('product.category')
        if vals['class_type_2']:
            categ_data = cat_obj.browse(cr, uid, vals['product_code_type_2'])
            parent_categ = categ_data.parent_id
            if parent_categ:
                parent_parent_categ = parent_categ.parent_id
                if parent_parent_categ:
            ...
            if prod_type == 'prepaid':
                raise osv.except_osv(('Warning!'),('Prepaid code type does not depend on credit class type. Please blank class type for prepaid type of product code types.'))
        res = super(sub_business_rule_master_2, self).create(cr, uid, vals, context=context)
        return res

    def write(self, cr, uid, ids, vals, context=None):
        self_data = self.browse(cr, uid, ids[0])
        cat_obj = self.pool.get('product.category')
        if 'class_type_2' in vals:
            class_type = vals['class_type_2']
        else:
            class_type = self_data.class_type_2
        if 'product_code_type_2' in vals:
            product_code_type = vals['product_code_type_2']
        else:
            product_code_type = self_data.product_code_type_2.id
        if class_type and product_code_type:
            categ_data = cat_obj.browse(cr, uid, product_code_type)
            parent_categ = categ_data.parent_id
            if parent_categ:
            ...
            if prod_type == 'prepaid':
                raise osv.except_osv(('Warning!'),('Prepaid code type does not depend on credit class type. Please blank class type for prepaid type of product code types.'))
        res = super(sub_business_rule_master_2, self).write(cr, uid, ids, vals, context=context)
        return res

sub_business_rule_master_2()

class account_config_master(osv.osv):
    _name = 'account.config.master'
    _columns = {
                'p_l_account_id':fields.many2one('account.info', 'P&L Account'),
                'operator':fields.many2one('arithmetic.operation.master', 'Arithematic Operation'),
    }
account_config_master()

class dsr_exclude_business_rule(osv.osv):
    _name = 'dsr.exclude.business.rule'
    _columns = {
                'dsr_emp_type':fields.many2one('dsr.employee.type','DSR Employee Type'),
                'credit_class':fields.many2one('credit.class','Credit Class'),
                'dsr_prod_code':fields.many2one('product.category','Product Code Type',domain="[('parent_id', '!=', False)]"),
                'dsr_soc_code':fields.many2one('product.product','SOC Code'),
                'commission_br':fields.many2one('business.rule.master','Business Rule')
                }

dsr_exclude_business_rule()

class arithmetic_operation_master(osv.osv):
    _name = 'arithmetic.operation.master'
    _columns = {
...
arithmetic_operation_master()

class hr_job(osv.osv):
    _inherit = "hr.job"
    _columns = {
                'model_id':fields.selection([('rsa', 'RSA'), ('stl', 'STL'), ('mid', 'MID'), ('rsm', 'RSM'), ('mm', 'MM'), ('dos', 'DOS'), ('ca', 'CA'), ('cs', 'CS'),('ism','ISM'),('mt','MT'),('rt','RT')], 'Heirarchy Level'),
    }
hr_job()

class tac_code_master(osv.osv):
    _inherit = 'tac.code.master'

tac_code_master()

class device_type_master(osv.osv):
    _inherit = 'device.type.master'

device_type_master()

class phone_type_master(osv.osv):
    _inherit = 'phone.type.master'

phone_type_master()

class credit_class_type(osv.osv):
    _inherit = 'credit.class.type'
...
class stores_type(osv.osv):
    _inherit = "stores.type"
...
class import_shopper_track(osv.osv):
    _inherit = "import.shopper.track"

import_shopper_track()

class import_goals(osv.osv):
    _inherit = "import.goals"

import_goals()

class import_wv_branded_dashboard(osv.osv):
    _inherit = 'import.wv.branded.dashboard'

import_wv_branded_dashboard()

class spliting_goals(osv.osv):
    _inherit = 'spliting.goals'

spliting_goals()

class labour_staffing(osv.osv):
    _inherit = 'labour.staffing'

labour_staffing()

class import_profit_loss(osv.osv):
    _inherit = 'import.profit.loss'

import_profit_loss()

class import_voc_file(osv.osv):
    _inherit = 'import.voc.file'

import_voc_file()

class fallouts_tmob(osv.osv):
    _inherit = 'fallouts.tmob'

fallouts_tmob()

class dsr_crash_process_deactivation(osv.osv):
    _inherit = 'dsr.crash.process.deactivation'

dsr_crash_process_deactivation()

class account_info(osv.osv):
    _inherit = 'account.info'

account_info()

class region_turnover_data(osv.osv):
    _inherit = 'region.turnover.data'

region_turnover_data()