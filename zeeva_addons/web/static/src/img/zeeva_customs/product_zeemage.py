...
class product_zeemage(osv.osv):
    ...
    _order = "view_type,view_type_earphone,view_type_headphone,view_type_speaker,view_type_earphone_finished,view_type_headphone_finished,view_type_speaker_finished,name"
