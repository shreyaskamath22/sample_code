...
class hr_employee(osv.osv):
    ...
    _columns = {
        'fam_spouse': fields.char("Spouse Name", size=256),
        'fam_spouse_dob': fields.date('Spouse Date of Birth'),
        ...
        'fam_father_dob': fields.date("Father's Date of Birth"),
        'fam_mother': fields.char("Mother's Name", size=128),
        'fam_mother_dob': fields.date("Mother's Date of Birth"),
        'landline': fields.char('Landline', size=32, readonly=False),
        'mobile_phone_spouse': fields.char('Mobile', size=10, readonly=False),
    }
