...
class statement_collection_old_records_new(report_sxw.rml_parse):
	def __init__(self, cr, uid, name, context=None):
		super(statement_collection_old_records_new, self).__init__(cr, uid, name, context=context)
...
##########################################################################################################################################
	...
	def set_page_total(self,new_amount,new_amount1,new_amount2,new_amount3,new_amount4,new_amount5,new_amount6,new_amount7,new_amount8,new_amount9,new_amount10,new_amount11,new_amount12,new_amount13,new_amount14,remark,party_name) :  ## for 14.0 % HHH
		cr=self.cr
		uid=self.uid
		...
		total_amount_sum.sum_amount14 += new_amount14
...
report_sxw.report_sxw('report.psd.statement.collection.old.records.new1', 'monthly.report', 'PSD_branch/addons_branch/psd_accounting/report/stmt_of_collection_old_records_new.rml', parser=statement_collection_old_records_new, header="False")
