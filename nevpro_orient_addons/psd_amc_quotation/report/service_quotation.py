...
report_sxw.report_sxw('report.amc.quotation', 'amc.quotation', 'PSD_branch/addons_branch/psd_amc_quotation/report/service_quotation.rml', parser=order, header=False)
