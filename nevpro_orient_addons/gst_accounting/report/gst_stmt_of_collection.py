...
class total_amount_sum :
	sum_amount=sum_amount1=sum_amount2=sum_amount3=sum_amount4=sum_amount5=sum_amount6=sum_amount7=sum_amount8=sum_amount9=sum_amount10=sum_amount11=sum_amount12=sum_amount13=sum_amount14=0 ## for 14.0 % HHH

class gst_statement_of_collection(report_sxw.rml_parse):
	def __init__(self, cr, uid, name, context=None):
		super(gst_statement_of_collection, self).__init__(cr, uid, name, context=context)
...
##########################################################################################################################################
	...
	def set_page_total(self,new_amount,new_amount1,new_amount2,new_amount3,new_amount4,new_amount5,new_amount6,new_amount7,new_amount8,new_amount9,new_amount10,new_amount11,new_amount12,new_amount13,new_amount14) :  ## for 14.0 % HHH
		cr=self.cr
		uid=self.uid
	...
	def get_account_name(self,self_id):
		cr = self.cr
		uid = self.uid
		dic = {
			'iob_one_1':'',
		...
		for res in self.pool.get('monthly.report').browse(cr,uid,[self_id]):
				name = []
				search_name = self.pool.get('account.account').search(cr,uid,[('account_selection','in',('iob_one','iob_two'))])
...
report_sxw.report_sxw('report.gst_stmt_of_collection', 'monthly.report', '/gst_accounting/report/gst_stmt_of_collection.rml', parser=gst_statement_of_collection, header="False")
