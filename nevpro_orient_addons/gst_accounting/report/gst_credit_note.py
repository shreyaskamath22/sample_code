...
class gst_credit_note(report_sxw.rml_parse):
	def __init__(self, cr, uid, name, context=None):
		super(gst_credit_note, self).__init__(cr, uid, name, context=context)
	...
	def get_tax_total(self,note_id):
		...
		dic['gst_total_value'] = format(total_amt,'.2f')
		dic['gst_taxable_value'] = format(taxable_amt,'.2f')
...
report_sxw.report_sxw('report.gst_credit_note', 'credit.note', '/gst_accounting/report/gst_credit_note.rml', parser=gst_credit_note, header="False")
